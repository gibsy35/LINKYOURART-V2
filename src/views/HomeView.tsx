          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-5 sm:p-8 lg:p-12 items-center">
            ...
            >
              ...
              <p className="text-sm sm:text-base md:text-lg text-white max-w-3xl mb-4 sm:mb-6 lg:mb-8 font-black uppercase tracking-tight leading-tight drop-shadow-lg">
                "{t('LINKYOURART UNITES CREATORS, PARTNERS, INDUSTRY & AUDIENCES—POWERING OBJECTIVE VALUE.', 'LINKYOURART UNIT CRÉATEURS, PARTENAIRES, INDUSTRIE ET PUBLICS—PROPULSANT LA VALEUR OBJECTIVE.')}"
              </p>
              ...
              <p className="text-base sm:text-base md:text-lg lg:text-xl xl:text-2xl text-on-surface-variant max-w-3xl mb-6 lg:mb-8 xl:mb-12 font-medium leading-relaxed opacity-90 border-l-4 lg:border-l-8 border-primary-cyan pl-6 lg:pl-10 py-2 lg:py-3">
                "{t('From rigorous professional auditing to LYA certification, navigate a secure ecosystem built on artistic excellence and creative transparency.', 'De l\'audit rigoureux à la certification LYA, naviguez dans un écosystème sécurisé bâti sur l\'excellence artistique et la transparence créative.')}"
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 mb-4 sm:mb-8 lg:mb-12 w-full sm:w-auto">
                ...
                >
                  <span>📋</span>
                  {t('VIEW LYA REGISTRY', 'VOIR LE REGISTRE LYA')}
                </button>
                <button
                ...
                >
                  {t('VALUATION INDEX (PRO)', 'INDICE DE VALORISATION (PRO)')}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <p className="text-xl text-on-surface-variant leading-relaxed opacity-90 font-medium text-justify">
                  {t('Creative projects have always had value. LinkYourArt gives them a recognized, shareable and verifiable one. For the first time, art benefits from an objective, secure, and internationally recognized evaluation standard.', 'Les projets créatifs ont toujours eu de la valeur. LinkYourArt leur en donne une reconnue, partageable et vérifiable. Pour la première fois, l\'art bénéficie d\'un standard d\'évaluation objectif, sécurisé et certifié internationalement.')}
                </p>
                <div className="p-6 bg-white/5 border-l-4 border-primary-cyan">
                  <p className="text-base text-white opacity-80 leading-relaxed text-justify">
                    "{t('We do not just index projects; we create an objective trust ecosystem where the valuation metrics of a masterpiece are documented, audited, and verifiable in real-time.', 'Nous ne nous contentons pas d\'indexer les projets ; nous créons un écosystème de confiance objective où les métriques d\'évaluation d\'un chef-d\'œuvre sont documentées, auditées et consultables en temps réel.')}"
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 lg:gap-6 relative">
              ...
              {[
                ...
                { 
                  id: '03', 
                  title: t('Standard of Trust', 'Standard de Confiance'), 
                  desc: t('Access an immutable ledger of objective evaluations. LYA Units act as standard indices representing certified project milestones.', 'Accédez à un registre immuable d\'évaluations objectives. Les unités LYA agissent comme des indices standards représentant les jalons certifiés du projet.'),
                  icon: <Zap size={24} />
                },
                { 
                  id: '04', 
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="overflow-x-auto">
            ...
            <table className="w-full text-left border-collapse">
              ...
              <tbody className="divide-y divide-white/5">
                <tr>
                  <td className="p-6 font-headline font-bold text-white text-sm uppercase tracking-wider">{t('Evaluation Standard', 'Nature du Standard')}</td>
                  <td className="p-6 text-sm text-white font-medium bg-primary-cyan/[0.02] border-x border-white/10">
                    <span className="text-primary-cyan font-black block mb-1">✓ {t('LYA Evaluation Index & Score', 'Index d\'Évaluation & Score LYA')}</span>
                    <p className="text-xs text-white/70 leading-relaxed">{t('Standardized indices representing verified project health, legal clearance, and creative milestones.', 'Indice standardisé représentant la santé certifiée du projet, la conformité réglementaire et les jalons créatifs.')}</p>
                  </td>
                  <td className="p-6 text-xs text-white/40 leading-relaxed">
                    <span className="text-rose-400/70 font-bold block mb-1">✗ {t('Opaque discretionary rights', 'Droits discrétionnaires opaques')}</span>
                    {t('Labels, studios, and agents capture most rights with no transparent or standardized evaluation framework.', 'Les labels, studios et agents captent la majorité des droits sans cadre d\'évaluation transparent ni standardisé.')}
                  </td>
                  <td className="p-6 text-xs text-white/30 leading-relaxed">
                    <span className="text-white/40 font-bold block mb-1">✗ {t('No formal verification', 'Aucune vérification formelle')}</span>
                    {t('Donations or symbolic perks (goodies) without any objective rating or structural auditing.', 'Dons ou récompenses symboliques (goodies) sans aucune notation objective ou audit structurel.')}
                  </td>
                </tr>

                <tr>
                  <td className="p-6 font-headline font-bold text-white text-sm uppercase tracking-wider">{t('Registry & Archival Tracking', 'Registre & Suivi d\'Audit')}</td>
                  <td className="p-6 text-sm text-white font-medium bg-primary-cyan/[0.02] border-x border-white/10">
                    <span className="text-primary-cyan font-black block mb-1">✓ {t('Sovereign Certifications Ledger', 'Registre Souverain de Certifications')}</span>
                    <p className="text-xs text-white/70 leading-relaxed">{t('A static, un-negotiated registry of active certifications and scoring, ensuring a clear and compliant historical log.', 'Un registre statique et non négociable des certifications et scores actifs, assurant un journal historique clair et conforme.')}</p>
                  </td>
                  <td className="p-6 text-xs text-white/40 leading-relaxed">
                    <span className="text-rose-400/70 font-bold block mb-1">✗ {t('Illiquid locked agreements', 'Accords verrouillés')}</span>
                    {t('Rights locked in long-term legacy contracts with no dynamic or accessible validation history.', 'Droits verrouillés dans des contrats historiques à long terme sans historique de validation accessible ou dynamique.')}
                  </td>
                  <td className="p-6 text-xs text-white/30 leading-relaxed">
                    <span className="text-white/40 font-bold block mb-1">✗ {t('No dynamic verification index', 'Aucun index dynamique')}</span>
                    {t('Funding locked with no audit mechanism to verify project milestones against initial commitments.', 'Fonds bloqués sans aucun mécanisme d\'audit pour vérifier les jalons du projet par rapport aux engagements initiaux.')}
                  </td>
                </tr>

                <tr>
                  <td className="p-6 font-headline font-bold text-white text-sm uppercase tracking-wider">{t('Evaluation Model', 'Modèle de Valorisation')}</td>
                  <td className="p-6 text-sm text-white font-medium bg-primary-cyan/[0.02] border-x border-white/10">
                    <span className="text-primary-cyan font-black block mb-1">✓ {t('Algorithmic LYA Score Indicator', 'Indicateur Algorithmique du LYA Score')}</span>
                    <p className="text-xs text-white/70 leading-relaxed">{t('Scoring fluctuations are based strictly on certified verified roadmap milestones and expert auditing.', 'Les variations de notation se basent strictement sur l\'atteinte de jalons validés et l\'audit d\'experts.')}</p>
                  </td>
                  <td className="p-6 text-xs text-white/40 leading-relaxed">
                    <span className="text-rose-400/70 font-bold block mb-1">✗ {t('Opaque unilateral valuations', 'Valorisations unilatérales opaques')}</span>
                    {t('Valuations imposed by intermediaries based on private, unverifiable criteria.', 'Valorisations imposées par les intermédiaires selon des critères privés et invérifiables.')}
                  </td>
                  <td className="p-6 text-xs text-white/30 leading-relaxed">
                    <span className="text-white/40 font-bold block mb-1">✗ {t('Unmonitored milestones', 'Aucun suivi de jalon')}</span>
                    {t('Project progression has no formal impact on the initial assessment, rendering progress untrackable.', 'La progression du projet n\'a aucun impact formel sur l\'évaluation initiale, rendant l\'évolution non traçable.')}
                  </td>
                </tr>

                <tr>
                  <td className="p-6 font-headline font-bold text-white text-sm uppercase tracking-wider">{t('Accessibility & Credibility', 'Crédibilité & Accessibilité')}</td>
                  <td className="p-6 text-sm text-white font-medium bg-primary-cyan/[0.02] border-x border-white/10">
                    <span className="text-primary-cyan font-black block mb-1">✓ {t('Objective Trusted Third-Party', 'Tiers de Confiance Objectif')}</span>
                    <p className="text-xs text-white/70 leading-relaxed">{t('Standardizing creative valuation across all sectors: music, film, fashion, gaming, architecture, and design.', 'Standardisation de la valorisation créative pour tous les secteurs : musique, cinéma, mode, jeux vidéo, architecture et design.')}</p>
                  </td>
                  <td className="p-6 text-xs text-white/40 leading-relaxed">
                     <span className="text-rose-400/70 font-bold block mb-1">✗ {t('High-friction entry barrier', 'Barrière d\'entrée élevée')}</span>
                     {t('Access limited only to creators signed with legacy agencies or majors, leaving independents excluded.', 'Accès limité uniquement aux créateurs signés par des agences ou majors traditionnelles, excluant les indépendants.')}
                  </td>
                  <td className="p-6 text-xs text-white/30 leading-relaxed">
                    <span className="text-white/40 font-bold block mb-1">✗ {t('No formal verification framework', 'Absence de cadre de vérification')}</span>
                    {t('No institutional clearance, no professional audit verifying your project authenticity.', 'Pas d\'approbation institutionnelle, pas d\'audit professionnel vérifiant l\'authenticité de votre projet.')}
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <div className="grid md:grid-cols-2 lg:hidden gap-8">
            <div className="p-8 rounded-3xl border border-primary-cyan/20 bg-primary-cyan/[0.02]/30 space-y-4">
              ...
              <ul className="space-y-4 text-xs text-left">
                <li>
                  ...
                  <span className="text-white/70 leading-relaxed">{t('A clear, standardized rating score representing project health, verified by professional validators.', 'Un score d\'évaluation clair et standardisé représentant la santé du projet, vérifié par des validateurs professionnels.')}</span>
                </li>
                <li className="pt-2 border-t border-white/5">
                  <strong className="text-white uppercase block text-[10px] tracking-wider mb-1">🔄 {t('SOVEREIGN AUDITED REGISTRY', 'REGISTRE AUDITÉ SOUVERAIN')}</strong>
                  <span className="text-white/70 leading-relaxed">{t('All certifications are archived securely in an un-negotiated public terminal for absolute clarity.', 'Toutes les certifications sont archivées en toute sécurité dans un terminal public non négociable pour une clarté absolue.')}</span>
                </li>
              </ul>
            </div>
            ...
            <div className="p-8 rounded-3xl border border-rose-500/10 bg-surface-dim space-y-4">
              ...
              <ul className="space-y-4 text-xs text-left">
                <li>
                  <strong className="text-white/80 uppercase block text-[10px] tracking-wider mb-1">✗ {t('CLASSIC EXCLUSIONS', 'SYSTEMES TRADITIONNELS OPALISÉS')}</strong>
                  <span className="text-white/50 leading-relaxed">{t('Traditional intermediaries capture rights with zero public tracking or transparent audit trail.', 'Les intermédiaires traditionnels captent les droits sans aucun suivi public ni piste d\'audit transparente.')}</span>
                </li>
                <li className="pt-2 border-t border-white/5">
                  <strong className="text-white/80 uppercase block text-[10px] tracking-wider mb-1">✗ {t('CROWDFUNDING WITHOUT GUARANTEES', 'CROWDFUNDING SANS GARANTIE D\'AUDIT')}</strong>
                  <span className="text-white/50 leading-relaxed">{t('Classic crowdfunding platforms provide only symbolic goodies without any professional monitoring of roadmap milestones.', 'Les plateformes de crowdfunding classiques n\'offrent que des goodies symboliques sans aucun suivi professionnel des jalons de la feuille de route.')}</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <section className="relative z-10 py-10 md:py-24 lg:py-10 md:py-24 lg:py-40 max-w-full max-w-7xl mx-auto px-6">
        ...
        <div className="bg-primary-cyan/5 border border-primary-cyan/20 p-5 sm:p-8 lg:p-12 rounded-sm backdrop-blur-md relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row items-center gap-5 sm:p-8 lg:p-12 relative z-10">
            ...
            <div>
              <h3 className="text-3xl font-black font-headline uppercase tracking-[0.2em] mb-4">{t('home.standard.title', 'The LYA')} <span className="text-white">{t('home.standard.title_cyan', 'Evaluation Standard')}</span></h3>
              <p className="text-on-surface-variant text-lg leading-relaxed opacity-80 text-justify">
                {t('home.standard.desc', 'LinkYourArt introduces the unique rating index for the creative ecosystem. Each LYA Unit represents a standardized index of future potential, calculated strictly through verified roadmap milestones, administrative conformity, and independent professional audits, establishing the only objective measure of creative value.')}
              </p>
            </div>
          </div>
        </div>

               ...
               <div className="flex flex-col md:flex-row gap-10 items-start">
                  ...
                  <div className="flex-1 space-y-6 pt-16 md:pt-24">
                     ...
                     <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 py-8 border-y border-white/5">
                        ...
                        <div className="space-y-1">
                          <p className="text-[10px] font-black text-on-surface-variant uppercase tracking-widest opacity-40">{t('PROJECTS', 'PROJETS')}</p>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="bg-white/5 border border-white/10 p-8 rounded-3xl space-y-6">
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div className="p-4 bg-white/5 rounded-2xl border border-white/10">
                              <p className="text-[10px] font-black text-white/40 uppercase tracking-widest mb-1">{t('INDEXED PROJECTS', 'PROJETS INDEXÉS')}</p>
        ...
        />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-16">
                ...
                <section>
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8 md:mb-12 gap-6">
                    <div>
                      ...
                      <p className="text-[10px] md:text-xs text-accent-gold uppercase tracking-widest font-bold opacity-40">{t('Manage your indexed creative registrations', 'Gérez vos enregistrements créatifs indexés')}</p>
                    </div>
                    <button 
                    ...
                    >
                      <Plus size={16} className="group-hover:rotate-90 transition-transform duration-500" /> {t('Index New Project', 'Indexer Nouveau Projet')}
                    </button>
                  </div>
                      ...
                      <div key={i} className="bg-surface-low/30 backdrop-blur-2xl border border-white/10 overflow-hidden group hover:border-primary-cyan/40 transition-all duration-700 flex flex-col h-full relative shadow-2xl rounded-2xl">
                        ...
                        <div className="p-6 md:p-8 flex flex-col flex-1 bg-surface-low/50 backdrop-blur-sm">
                          <div className="grid grid-cols-1 gap-4 md:gap-8 mb-6 md:mb-10">
                            <div className="space-y-1">
                              <p className="text-[10px] md:text-xs text-accent-gold font-black uppercase tracking-[0.2em] md:tracking-[0.3em] opacity-40">{t('Evaluation Index', 'Index d\'Évaluation')}</p>
              ...
              <div className="lg:col-span-4 space-y-16">
                ...
                {/* Project Allocation - Premium Pie */}
                <section className="bg-surface-low/30 border border-white/10 p-6 md:p-10 backdrop-blur-2xl rounded-2xl shadow-2xl">
                  <h3 className="text-xl md:text-2xl font-black uppercase mb-6 md:mb-10 flex items-center gap-3 md:gap-4">
                    <PieChartIcon className="text-primary-cyan" size={24} /> {t('Portfolio Mix', 'Mix de Portefeuille')}
                  </h3>
            ...
            <section className="relative overflow-hidden rounded-3xl group">
              ...
              <div className="relative bg-surface-low/40 backdrop-blur-3xl border border-white/10 p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8">
                <div className="flex-1">
                  ...
                  <p className="text-sm md:text-lg text-on-surface-variant font-medium max-w-xl mb-6">
                    {t('Intelligence Discovery Terminal: Identify high-potential creative projects before they reach final certification. Use our proprietary filters to evaluate next-generation creations.', 'Terminal de Découverte d\'Intelligence : Identifiez les projets créatifs à haut potentiel avant qu\'ils n\'atteignent le grade de certification finale. Utilisez nos filtres propriétaires pour évaluer les créations de nouvelle génération.')}
                  </p>
                  <button 
                    onClick={handleScan}
                    disabled={isScanning}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 lg:gap-16">
              <div className="lg:col-span-8 space-y-8 md:space-y-12 lg:space-y-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                  {/* Portfolio Allocation - Premium Pie */}
                  <section className="bg-surface-low border border-white/5 p-6 md:p-10 backdrop-blur-2xl">
                    <h3 className="text-lg md:text-2xl font-black uppercase italic mb-8 md:mb-10 flex items-center gap-3 md:gap-4">
                      <PieChartIcon className="text-primary-cyan" size={28} /> {t('Portfolio Allocation', 'Allocation du Portefeuille')}
                    </h3>
                ...
                <section className="bg-gradient-to-br from-primary-cyan/20 to-accent-gold/20 border border-primary-cyan/30 p-8 rounded-2xl relative overflow-hidden group shadow-2xl">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-sm text-on-surface-variant italic mb-8 max-w-md opacity-80 leading-relaxed">
                      {t('Our AI-driven engine identifies high-potential creative projects and indexes. Get early access to certified audits and professional evaluation metrics.', 'Notre moteur piloté par l\'IA identifie les projets créatifs et leurs indices. Obtenez un accès anticipé aux audits certifiés et aux indicateurs professionnels d\'évaluation.')}
                    </p>
                    <button 
                      onClick={handleScan}
                      disabled={isScanning}
                ...
                <section className="bg-surface-low border border-white/5 p-5 md:p-8 lg:p-12 backdrop-blur-2xl relative overflow-hidden">
                  ...
                  <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 md:mb-10 lg:mb-12 gap-4 md:gap-6 relative z-10">
                    <div>
                      ...
                      <p className="text-xs md:text-xs text-on-surface-variant uppercase tracking-widest font-bold opacity-40">{t('Real-time institutional project tracking', 'Suivi institutionnel des projets en temps réel')}</p>
                    </div>
              ...
              <div className="w-full lg:w-1/3 bg-primary-cyan/5 p-6 md:p-8 border-b lg:border-b-0 lg:border-r border-white/5 flex flex-col justify-between relative overflow-hidden shrink-0">
                ...
                <div className="relative z-10">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-black uppercase italic leading-none tracking-tighter mb-2 sm:mb-4">
                    {t('Index', 'Indexer')} <br />
                    <span className="text-primary-cyan">{t('New Project', 'Nouveau Projet')}</span>
                  </h2>
                  <p className="text-[10px] text-on-surface-variant font-bold uppercase tracking-widest leading-relaxed">
                    {t('Initialisez votre projet créatif sur le registre certifié LYA. Notre IA auditera votre PI et générera un indice de valorisation.', 'Initialize your creative project on the certified LYA registry. Our AI will audit your IP and generate a valuation index.')}
                  </p>
                </div>
              ...
              <div className="flex-1 p-5 sm:p-8 md:p-10 bg-surface-low/50 backdrop-blur-md overflow-y-auto custom-scrollbar pb-32 lg:pb-10">
                <form onSubmit={handleCreateProject} className="space-y-6 md:space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    ...
                    <div className="space-y-2">
                      <label className="text-[10px] uppercase tracking-[0.2em] text-primary-cyan font-black">{t('Project Category', 'Catégorie de Projet')}</label>
                      <select 
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div className="space-y-2 flex flex-col justify-center">
                      <label className="text-[10px] uppercase tracking-[0.2em] text-primary-cyan font-black">{t('Total Project Valuation ($)', 'Valorisation Totale du Projet ($)')}</label>
                      ...
                      <div className="flex flex-wrap items-center justify-between gap-3">
                        ...
                        <button
                          ...
                          onClick={async () => {
                            ...
                            setIsUploading(true);
                            onNotify?.(t('AI Engine: Visualizing creative project...', 'Moteur IA : Visualisation du projet créatif...'));
                            try {

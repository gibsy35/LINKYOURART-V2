    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="flex flex-col gap-4">
        <button
          ...
          className="w-full py-4 bg-primary-cyan text-surface-dim font-black uppercase tracking-[0.3em] hover:bg-white transition-all disabled:opacity-50 flex items-center justify-center gap-2 text-xs"
        >
          {processing ? (
            <>
        ...
        <button
          ...
          className="w-full py-4 bg-gradient-to-r from-emerald-500/20 to-teal-500/20 border border-emerald-500/40 hover:border-emerald-400 hover:from-emerald-500/30 hover:to-teal-500/30 text-emerald-400 font-black uppercase tracking-[0.25em] transition-all flex items-center justify-center gap-2 text-[11px]"
        >
          <span>✨ {t('SIMULATE PAYMENT (BYPASS)', 'SIMULER LE PAIEMENT (BYPASS)')}</span>
        </button>

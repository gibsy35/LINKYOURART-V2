  ...
  return (
    <div className="space-y-8 pb-12 relative min-h-screen">
      <LockedOverlay
        ...
        description={t(
          'In compliance with LYA Protocol v3.0 (Regulatory-First Architecture), high-frequency professional settlement batching and instant contractual transfers are currently suspended in this regulatory intermission phase.',
          "Conformément à la version v3.0 du protocole LYA (Regulatory-First), le traitement par lots de règlements professionnels et les transferts contractuels instantanés sont suspendus durant cette phase de gel réglementaire."
        )}
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 relative z-10">
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-on-surface-variant/80 font-medium leading-relaxed max-w-5xl text-justify uppercase tracking-wider">
              {t(
                'In compliance with LYA Protocol v3.0 (Regulatory-First Architecture), negotiable secondary market transactions and high-frequency settlements are in a regulatory intermission phase. The current feed operates on simulated, static datasets for objective certification, LYA Score evaluation, and professional audit indexing purposes only.',
                "Conformément à la version v3.0 du protocole LYA (Regulatory-First), les transactions négociables et les règlements par lots sont actuellement suspendus dans l'attente d'agréments. Le flux actuel fonctionne sur des données statiques simulées à des fins exclusives de certification objective, d'évaluation de LYA Score et d'indexation d'audits professionnels."
              )}
            </p>
          </div>

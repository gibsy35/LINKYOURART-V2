                ...
                <form className="space-y-4" onSubmit={handleLogin}>
                  {error && (
                    <motion.div 
                      ...
                      animate={{ opacity: 1, y: 0 }}
                      className="p-4 bg-red-500/10 border border-red-500/20 text-red-500 text-xs rounded-xl"
                    >
                      {error.toLowerCase().includes('unauthorized-domain') ? (
                        <div className="space-y-3 text-left">
                          ...
                          <ol className="list-decimal list-inside space-y-1 text-gray-400 font-sans normal-case">
                            <li>

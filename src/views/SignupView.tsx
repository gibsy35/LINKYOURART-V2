                    ...
                    <div className="p-4 bg-[#a78bfa]/10 border border-[#a78bfa]/30 rounded-xl text-center space-y-3">
                      {error.toLowerCase().includes('unauthorized-domain') ? (
                        <div className="space-y-3 text-left">
                          <div className="font-bold uppercase tracking-wider text-center text-red-400 text-xs">
                            {t('Firebase Unauthorized Domain Error', 'Erreur de domaine Firebase non autorisé')}
                          </div>
                          <p className="text-gray-300 leading-relaxed font-sans normal-case text-xs">
                            {t(
                          ...
                          <ol className="list-decimal list-inside space-y-1 text-gray-400 font-sans normal-case text-[11px]">
                            <li>

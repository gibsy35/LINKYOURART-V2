...
export const WalletView: React.FC<WalletViewProps> = ({ user, onNotify, onViewChange }) => {
  ...
  return (
    <div className="space-y-6 pb-20">
      <PageHeader 
        titleWhite={t('Certification &', 'Certification &')}
        titleAccent={t('Valuation', 'Valorisation')}
        description={t('SECURE STATEMENT: VERIFY AUDIT STATUS, SCORE VALUATIONS, AND DEPOSITARY CERTIFICATES.', 'RELEVÉ SÉCURISÉ : CONTRÔLE DES STATUTS D\'AUDIT, VALORISATION DES SCORES ET CERTIFICATS DÉPOSITAIRES.')}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
              ...
              >
                ...
                <span className="text-[10px] font-black uppercase tracking-widest">{t('LYA REGISTRY', 'REGISTRE LYA')}</span>
              </button>
              <button 
        ...
        <div className="space-y-6">
          <div className="bg-surface-low border border-white/5 p-8 rounded-[2.5rem] relative overflow-hidden group h-full">
            ...
            >
              {t('EXPLORER LE REGISTRE', 'EXPLORE THE REGISTRY')}
            </button>
          </div>
        </div>
      </div>

  ...
  return (
    <div className="space-y-12 pb-24 relative min-h-screen">
      <LockedOverlay
        ...
        description={t(
          'In compliance with LYA Protocol v3.0 (Regulatory-First Architecture), swipe-based interactive discovery and contractual indexing is currently deferred to a future phase. The terminal operates on static, sandboxed datasets for objective certification, LYA Score evaluation, and professional audit indexing purposes only.',
          "Conformément à la version v3.0 du protocole LYA (Regulatory-First), la découverte interactive par balayage (Swipe) et l'indexation de contrats sont actuellement suspendues. Le terminal fonctionne sur des données statiques pour la certification objective, l'évaluation du LYA Score et l'indexation d'audits professionnels."
        )}

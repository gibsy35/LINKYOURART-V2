              ...
              <div className="lg:col-span-7 space-y-8 relative z-20">
                <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: 0.2, duration: 0.8, ease: "easeOut" }}>
                  ...
                  <motion.p initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.5 }}
                    ...
                    "{t('Objective trust is the foundation of creative value.', 'La confiance objective est le fondement de la valeur créative.')}"
                  </motion.p>

                  <p className="text-white/70 text-base md:text-lg xl:text-xl font-medium leading-relaxed max-w-2xl">
                    {t(
                      "20 years of history. One standard: objective creative value. LinkYourArt certifies it, measures it and secures it — for every creator and professional.",
                      "20 ans d'histoire. Un seul étalon : la valeur créative objective. LinkYourArt la certifie, la mesure et la sécurise — pour tous les créateurs et professionnels."
                    )}
                  </p>

          ...
          >
            ...
            <div className="p-8 space-y-6">
              ...
              <p className="text-[10px] text-on-surface-variant/20 text-center uppercase tracking-widest font-black italic text-justify">
                {t('BY_EXECUTING_THIS_SEND_YOU_AGREE_TO_OUR_INSTITUTIONAL_COMMUNICATION_LYA SYSTEM_V3.0', 'EN_EXÉCUTANT_CET_ENVOI_VOUS_ACCEPTEZ_NOTRE_LYA SYSTEME_DE_COMMUNICATION_INSTITUTIONNEL_V3.0')}
              </p>
            </div>
          </motion.div>
        </div>
